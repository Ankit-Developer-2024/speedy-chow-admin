...
export const POPModal = function POPModal({ children, onClose ,onOk }) {
  return (
    <div className='w-full flex flex-row items-center justify-center fixed top-0 left-0 bottom-0 right-0 bg-[#00000040] z-1'  >
