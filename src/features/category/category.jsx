    ...
    return (
        <>
            <div className="w-full px-5 py-3 relative">
                ...
                <a href="#addCategory"          
                    className="bg-orange-400 p-2 my-2 inline-block rounded-md font-medium text-white hover:bg-amber-500"
                  >Add Category</a>
                <Toaster />
                <br />
                {isLoading ?
                ...
                <div className="flex flex-row gap-3 items-start justify-start ">
                    <div className="w-[200px] h-[152px] border border-dashed border-gray-400 rounded-xl  relative">
                        ...
                        <input className="w-[200px] h-[150px] absolute top-0 opacity-0"
                            type="file"
                            {...register("image", {
                    ...
                    <form className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input className="bg-orange-400 py-2 my-1 px-5 rounded-md font-medium text-white hover:bg-amber-500" type="submit" value="Create" />
                        <button className="bg-yellow-400 py-2 px-5 rounded-md font-medium text-white hover:bg-yellow-500" onClick={() => reset()}  >Reset</button>
